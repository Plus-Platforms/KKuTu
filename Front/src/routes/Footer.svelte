...
<footer class="p-4 bg-white sm:p-6 dark:bg-gray-800 ">
  <div class="max-w-screen-xl mx-auto md:flex md:justify-between mb-6 mt-6">
    ...
    <div class="">
      <div>
      <a href="https://www.grac.or.kr/Statistics/Popup/Pop_StatisticsDetails.aspx?850c3e6034aa5ae3efd1751a7b1bfabaa6c813a6a053e8e5ec12581d53453bb0" target="_blank"><img src="/img/web/grac.png" class="h-12" alt="Rating"/></a>
      </div>
    </div>
  </div>
</footer>